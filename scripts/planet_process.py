...
def main():
    ...
    output_dict['LOCs not on best server'] = ntp_database_df_unpivoted.loc[ntp_database_df_unpivoted['s_rsrp'].isnull() | ntp_database_df_unpivoted['s_cinr'].isnull()]['location_id']

    return ntp_database_final_df, output_dict, '2'
